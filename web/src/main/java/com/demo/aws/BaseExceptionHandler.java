...
public class BaseExceptionHandler {
    ...
    @ExceptionHandler({UsernameExistsException.class, com.demo.aws.exceptions.UserNotFoundException.class, TenantDataNotFoundException.class, TenantAliasNotFoundException.class})
    public ErrorResponse notFoundExceptionHandler(Exception ex) {
        ...
        return new ErrorResponse(String.valueOf(errorCodes.getCode()),errorCodes.getMessage(), ex.getMessage(), null);
    }
    ...
    @ExceptionHandler({FailedAuthenticationException.class, NotAuthorizedException.class, InvalidPasswordException.class})
